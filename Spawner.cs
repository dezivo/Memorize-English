...
public class Spawner : MonoBehaviour {
    ...
    void Update() {
        ...
        if (pairsMatched == numPairs) {
            ...
            if (random >= 0.80f && GameObject.FindGameObjectsWithTag("Lives").Length < 3) AddLife(); 
	...
	private void ApplyWordParameter(){
		...
		//TODO Maybe Tuning Words Design
		if (wordParameter == 4) {
